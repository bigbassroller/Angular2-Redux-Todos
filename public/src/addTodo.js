System.register(['angular2/core', './todoActions', ], function(exports_1) {
    ...
    var core_1, todoActions_1, module_1;
    var AddTodo;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AddTodo = (function () {
                ...
                AddTodo = __decorate([
                    ...
                    __metadata('design:paramtypes', [(typeof (_a = typeof module_1.AppStore !== 'undefined' && module_1.AppStore) === 'function' && _a) || Object, todoActions_1.TodoActions])
                ], AddTodo);
                return AddTodo;
                var _a;
            })();
